<div class="main">
    <div class="card-isi">
        <div class="header-card">
            <p>{{ $editMode ? 'Edit Data Jenis Karcis' : 'Tambah Data Jenis Karcis' }}</p>
            <hr />
        </div>
                ...
                <div class="input-area">
                    <div class="row-input">
                        <div class="row-area">
                            <div class="input-ctn">
                                <p>Nama Karcis</p>
                                <input class="input-t" placeholder="Nama Karcis" type="text" wire:model="nama"
                                    name="nama" id="" />
                            </div>
                        </div>
                    </div>
                    <div class="row-input">
                        <div class="row-area">
                            <div class="input-ctn">
                                <p>Harga Karcis</p>
                                <input class="input-t" placeholder="Harga Karcis" type="text" wire:model="harga"
                                    name="harga" id="" />
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="responsive-table">
                        ...
                        <tbody>
                            @foreach ($karcis as $kcs)
                                <tr>
                                    <td>{{ $kcs->nama }}</td>
                                    <td>{{ 'Rp ' . number_format($kcs->harga, 0, ',', '.') }}</td>
                                    <td>
                                        <div class="aksi">
